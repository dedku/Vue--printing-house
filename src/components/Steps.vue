    ...
    <div class="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12">
      ...
      <h2 class="max-w-lg mb-6 font-sans text-3xl font-bold leading-none tracking-tight text-gray-900 sm:text-4xl md:mx-auto">
        <span class="relative inline-block">
          ...
          <span class="relative">Od</span>
        </span>
        projektu, do druku
      </h2>
      <p class="text-base text-gray-700 md:text-lg">
        Dzięki wieluletniemu doświadczeniu, wypracowaliśmy łatwą metode współpracy z klientem
      </p>
    </div>
    <div class="grid gap-8 row-gap-5 md:row-gap-8 lg:grid-cols-3">
      <div class="p-5 duration-300 transform bg-white border-2 border-dashed rounded shadow-sm border-deep-purple-accent-100 hover:-translate-y-2">
        <div class="flex items-center mb-2">
          ...
          <p class="text-lg font-bold leading-5">Wybierz usługę</p>
        </div>
        <p class="text-sm text-gray-900">
          Z gamy naszych usług wybierz te usługi, którymi jesteś zainteresowany
        </p>
      </div>
      <div class="p-5 duration-300 transform bg-white border-2 border-dashed rounded shadow-sm border-deep-purple-accent-200 hover:-translate-y-2">
        <div class="flex items-center mb-2">
          ...
          <p class="text-lg font-bold leading-5">Wybierz pliki</p>
        </div>
        <p class="text-sm text-gray-900">
          Dzięki naszem systemowi, do każdej z wybranych usług możesz dołączyć pliki graficzne
        </p>
      </div>
      <div class="relative p-5 duration-300 transform bg-white border-2 rounded shadow-sm border-deep-purple-accent-700 hover:-translate-y-2">
        <div class="flex items-center mb-2">
          ...
          <p class="text-lg font-bold leading-5">Odbierz produkt</p>
        </div>
        <p class="text-sm text-gray-900">
          Po wykonaniu wydruku, wysyłamy produkt bezpośrednio do Twoich drzwi
        </p>
